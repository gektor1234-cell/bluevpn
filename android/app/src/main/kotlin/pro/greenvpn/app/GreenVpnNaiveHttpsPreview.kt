...
object GreenVpnNaiveHttpsPreview {
    data class Snapshot(
    ...
    private const val CONTROLLER_CLASS = "pro.greenvpn.naive.NaiveHttpsController"

    fun isAvailable(context: Context): Boolean {
        if (!BuildConfig.GREENVPN_NAIVE_HTTPS_PREVIEW_ENABLED) return false
        return try {
