...
#
# Usage:
#   powershell -NoProfile -ExecutionPolicy Bypass -File .\bluevpn_patch_all_v8.ps1
#   powershell -NoProfile -ExecutionPolicy Bypass -File .\bluevpn_patch_all_v8.ps1 -SkipDeploy
#   powershell -NoProfile -ExecutionPolicy Bypass -File .\bluevpn_patch_all_v8.ps1 -SkipBuild
#
param(
...
function Run-Step {
  param([string]$Title, [string]$Exe, [string[]]$Args)
