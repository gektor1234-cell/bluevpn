...
- Verification: 58 backend tests, 6 Flutter tests and 6 Android Hysteria config tests pass. `flutter analyze` returns code 0 with only the pre-existing 184 lint/info items; release gate passes with `Warnings: 0`, `Errors: 0`.
