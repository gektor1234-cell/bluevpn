...
Последнее обновление: 2026-08-28 МСК
...
| 8 | Дать production go/no-go | **Готово:** Android `0.4.8` и ручные продажи опубликованы; для будущей подписанной Windows, recurring или рекламной версии потребуется новое разрешение |
| 9 | Провести финальную пользовательскую приёмку | **Готово для Android 0.4.8:** exact physical install/UI/payment-button acceptance пройден |

## Что блокирует формальное закрытие текущей v1

Инженерных и внешних сервисных блокеров у текущего direct-download релиза с
ручной оплатой нет. Android `0.4.8+2026082802` и Windows `0.4.6+4636`
