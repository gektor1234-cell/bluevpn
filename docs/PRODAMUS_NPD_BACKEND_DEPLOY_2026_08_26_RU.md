...
|---:|---|---|
| 1 | Заявка Prodamus | Выполнено 2026-08-26: полная анкета, два публичных канала, публичная оферта и обязательные документы успешно отправлены; письмо подтверждения заявлено Prodamus, но ещё не доставлено на момент фиксации |
| 2 | Одобрение Green VPN | Ожидается email-подтверждение и проверка Prodamus со средним заявленным сроком 1–3 рабочих дня; не подменяется технической готовностью |
