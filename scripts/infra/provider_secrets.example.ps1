...
# Optional: keep extra RUVDS API v2 tokens here when testing another funded account.
$env:GREENVPN_RUVDS_API_KEY_2 = "CHANGE_ME"
$env:GREENVPN_RUVDS_API_KEYS = "CHANGE_ME;CHANGE_ME"
