...
changelog = json.dumps(
    [
        "Обновлен интерфейс Fusion и быстрые действия подключения.",
        "Улучшено восстановление фактически активного маршрута после перезапуска интерфейса.",
        "Добавлена безопасная отмена фонового восстановления подключения.",
    ],
    ensure_ascii=False,
)
updates = {
