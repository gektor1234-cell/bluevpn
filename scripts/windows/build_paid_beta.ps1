param(
    ...
    [string]$Mode = "both",
    [string]$AppVersion = "0.3.21-paid-beta.1",
    [string]$WindowsAppVersion = "0.3.21-paid-beta.1",
    [ValidateRange(0, 65535)]
    [int]$WindowsBuildNumber = 3001,
    [string]$AndroidBuildName = "0.3.21",
    ...
    [string]$OutDir = "C:\BlueVPN_Builds\paid_beta_20260730_b3001",
