param(
    ...
    [string]$Mode = "both",
    [string]$AppVersion = "0.3.19-paid-beta.1",
    [string]$WindowsAppVersion = "0.3.19-paid-beta.1",
    [ValidateRange(0, 65535)]
    [int]$WindowsBuildNumber = 2914,
    [string]$AndroidBuildName = "0.3.19",
    ...
    [string]$OutDir = "C:\BlueVPN_Builds\paid_beta_20260729_b2914",
