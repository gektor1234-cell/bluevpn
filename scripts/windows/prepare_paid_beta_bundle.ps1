...
$artifacts = @(
    Get-ArtifactRecord -Platform "android" -Path $androidTarget -BuildNumber $AndroidBuildNumber
    Get-ArtifactRecord -Platform "windows" -Path $windowsTarget -BuildNumber ""
)
