...
param(
    ...
    [string]$StableAndroidVersion = '0.4.9',
    [string]$StableAndroidBuild = '2026082803',
    [string]$StableAndroidSha256 = 'B2E4D29F227853828F5942422C391F1A5B4A22F625B7B5EC5B036E1C94E857E8',
    [long]$StableAndroidSize = 56364901,
    ...
    [string]$StableAndroidMinSupportedVersion = '0.4.9',
