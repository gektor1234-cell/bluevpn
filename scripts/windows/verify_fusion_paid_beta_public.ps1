...
param(
    ...
    [string]$StableWindowsVersion = '0.4.10',
    [string]$StableWindowsBuild = '4643',
    [string]$StableWindowsSha256 = '457630468B25767E96FB203D548AB4BE37008F188FEE1BC8D51CB5F509332EF1',
    [long]$StableWindowsSize = 52841984,
    [string]$StableAndroidVersion = '0.4.13',
    [string]$StableAndroidBuild = '2026090701',
    [string]$StableAndroidSha256 = 'A70DA5C0F2D86627BAABFB44B366A1E96361DADDE20EA20B90DCD636AE38147A',
    [long]$StableAndroidSize = 56407381,
    ...
    [string]$StableAndroidMinSupportedVersion = '0.4.13',
    [string]$StableWindowsMinSupportedVersion = '0.4.10',
