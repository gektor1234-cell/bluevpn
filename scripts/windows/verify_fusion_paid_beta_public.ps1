...
param(
    ...
    [string]$StableWindowsVersion = '0.4.12',
    [string]$StableWindowsBuild = '4645',
    [string]$StableWindowsSha256 = '0C0C2789B39745233B50118F8D21E2211CAD6136290690F572C5CFD1AFAFA8EB',
    [long]$StableWindowsSize = 54075904,
    [string]$StableAndroidVersion = '0.4.17',
    [string]$StableAndroidBuild = '2026091201',
    [string]$StableAndroidSha256 = '332B29C7555A0A6421C67FFD69C6966962390DA5BB182596A69661C4A190A450',
    [long]$StableAndroidSize = 56470189,
    [string]$StableBackendVersion = '0.9.166-product-hardening.1',
    [string]$BetaBackendVersion = '0.9.154-fusion-actions.1',
    [bool]$StableRequired = $true,
    [string]$StableMinSupportedVersion = '',
    [string]$StableAndroidMinSupportedVersion = '0.4.17',
    [string]$StableWindowsMinSupportedVersion = '0.4.12',
