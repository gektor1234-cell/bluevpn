...
param(
    ...
    [string]$StableAndroidVersion = '0.4.16',
    [string]$StableAndroidBuild = '2026090801',
    [string]$StableAndroidSha256 = 'D5A171C39E674A2FF94B8C8C631362B777187C8376B097577056E445CB5965A5',
    [long]$StableAndroidSize = 56467221,
    ...
    [string]$StableAndroidMinSupportedVersion = '0.4.16',
