...
param(
    ...
    [string]$StableAndroidVersion = '0.4.10',
    [string]$StableAndroidBuild = '2026082804',
    [string]$StableAndroidSha256 = 'E12E609C38B1B05879999404E7BE0230E0111E1FB28B660EBBFF940769BACA46',
    [long]$StableAndroidSize = 56365761,
    [string]$StableBackendVersion = '0.9.164-autorenew-checkout.1',
    [string]$BetaBackendVersion = '0.9.154-fusion-actions.1',
    [bool]$StableRequired = $true,
    [string]$StableMinSupportedVersion = '',
    [string]$StableAndroidMinSupportedVersion = '0.4.10',
