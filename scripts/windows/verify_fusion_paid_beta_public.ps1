...
param(
    ...
    [string]$StableWindowsVersion = '0.4.11',
    [string]$StableWindowsBuild = '4644',
    [string]$StableWindowsSha256 = '100EE4AC758D9F0095375F2726CF0086BBAC8EA1125AE1439895748D847498C1',
    [long]$StableWindowsSize = 52853760,
    [string]$StableAndroidVersion = '0.4.14',
    [string]$StableAndroidBuild = '2026090702',
    [string]$StableAndroidSha256 = '39323FCACEEE074191E32477DFFBE407D78435A122D1D3CAF27B024D357FDE4A',
    [long]$StableAndroidSize = 56443701,
    ...
    [string]$StableAndroidMinSupportedVersion = '0.4.14',
    [string]$StableWindowsMinSupportedVersion = '0.4.11',
