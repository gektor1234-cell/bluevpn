...
param(
    ...
    [string]$StableWindowsVersion = '0.4.9',
    [string]$StableWindowsBuild = '4642',
    [string]$StableWindowsSha256 = '0BDD42D9159B8985079D0593BFEDE339AF7D5D3934E79C68F4C81BE74F747D04',
    [long]$StableWindowsSize = 52843520,
    ...
    [string]$StableWindowsMinSupportedVersion = '0.4.9',
