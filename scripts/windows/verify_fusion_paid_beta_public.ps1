...
param(
    ...
    [string]$StableAndroidVersion = '0.4.15',
    [string]$StableAndroidBuild = '2026090703',
    [string]$StableAndroidSha256 = 'F9193290AC4EAE62F94886AC176D74CD0D5B98DFC7643E13B97509D81C43BE44',
    [long]$StableAndroidSize = 56446133,
    ...
    [string]$StableAndroidMinSupportedVersion = '0.4.15',
