[CmdletBinding()]
param(
    [string]$BetaVersion = '0.4.4-paid-beta.1',
    [string]$BetaAndroidBuild = '2026081104',
    [int]$BetaWindowsBuild = 4401,
    [string]$BetaAndroidSha256 = '78D0F403EE948B52EC4D8382BB0AF0BE2CC23ADF84204C7CAE65BC9A93AE70A4',
    [long]$BetaAndroidSize = 56332069,
    [string]$BetaWindowsSha256 = '4A57F48C5FCF23D825E855C8D9450244DCCBFF363311E841A613F97088B24409',
    [long]$BetaWindowsSize = 55493632,
