...
- Green VPN changes: pre-connect socket PID attribution with normalized
  IPv4/IPv6 tuples, flow/socket-table fallback, exact SOCKS5 framing, long
...
| `ProxyBridgeCore.dll` | `00A2EB9DCFFBDA71C1859DA40E32DFAF8E93856DE3C4A3ADB1853395AB43C192` |
